  ...
  Morris.Line = (function (_super) {
    ...
    Line.prototype.hoverContentForRow = function (index) {
      ...
      for (j = _i = 0, _len = _ref.length; _i < _len; j = ++_i) {
        y = _ref[j];
        content +=
          "<div class='morris-hover-point' style='color: " + this.colorFor(row, j, "label") + "'>\n  " + this.options.labels[j] + ":\n  " + this.yLabelFormat(y) + "\n</div>";
      }
    ...
    Line.prototype.drawXAxis = function () {
      ...
      drawLabel = function (labelText, xpos) {
        ...
        labelBox = label.getBBox();
        if (
          (prevLabelMargin == null || prevLabelMargin >= labelBox.x + labelBox.width || (prevAngleMargin != null && prevAngleMargin >= labelBox.x)) &&
          labelBox.x >= 0 &&
